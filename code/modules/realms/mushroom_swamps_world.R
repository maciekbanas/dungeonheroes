  enemies <- stats::setNames(lapply(enemy_specs, function(spec) {
    enemy <- game$add_sprite(
      name = spec$name,
      url = "dungeonheroes-assets/sprites/enemies/mushroom_man/mushroom_man_idle.png",
      x = spec$x,
      y = spec$y,
      frame_width = 100,
      frame_height = 100,
    ...
    lapply(c("down", "left", "right", "up"), function(direction) {
      enemy$add_animation(
        ...
        url = sprintf("dungeonheroes-assets/sprites/enemies/mushroom_man/mushroom_man_walk_%s.png", direction),
    ...
    lapply(c("down", "left", "right", "up"), function(direction) {
      enemy$add_animation(
        ...
        url = sprintf("dungeonheroes-assets/sprites/enemies/mushroom_man/mushroom_man_damage_%s.png", direction),
        frame_width = 100, frame_height = 100,
    ...
    enemy$add_animation(
      suffix = "attack",
      url = "dungeonheroes-assets/sprites/enemies/mushroom_man/mushroom_man_attack.png",
      frame_width = 100, frame_height = 100,
    ...
    lapply(c("left", "right"), function(direction) {
      enemy$add_animation(
        ...
        url = sprintf("dungeonheroes-assets/sprites/enemies/mushroom_man/mushroom_man_attack_%s.png", direction),
        frame_width = 100, frame_height = 100,
        frame_count = 4, frame_rate = 6
      )
    })
    enemy$add_animation(
      suffix = "destroy",
      url = "dungeonheroes-assets/sprites/enemies/mushroom_man/mushroom_man_destroy.png",
      frame_width = 100, frame_height = 100,
  ...
  dead_tree_bottom <- game$add_static_sprite(
    ...
    url = "dungeonheroes-assets/terrain/mushroom_swamps/dead_tree_1_bottom.png",
    x = 550,
    y = 650
  )
  ...
  dead_tree_top <- game$add_image(
    ...
    url = "dungeonheroes-assets/terrain/mushroom_swamps/dead_tree_1_top.png",
    x = 550,
    y = 650 - map_tile_size
  )
  ...
  wizard <- game$add_sprite(
    name = "wizard",
    url = "dungeonheroes-assets/sprites/npc/wizard/wizard_idle.png",
    x = 1600,
    y = 800,
    frame_width = 100,
    frame_height = 100,
  ...
  wizard$add_animation(
    suffix = "talk",
    url = "dungeonheroes-assets/sprites/npc/wizard/wizard_talk.png",
    frame_width = 100, frame_height = 100,
  ...
  mushroom_spirit <- game$add_sprite(
    ...
    url = "dungeonheroes-assets/sprites/npc/mushroom_spirit/mushroom_spirit.png",
    x = 2850,
    y = 5850,
    frame_width = 32,
    frame_height = 32,
