  enemy_specs <- list(
    list(name = "mushroom_man_1", type = "mushroom_man", x = 1150, y = 1650, hit_points = 5, damage = 4, motion = "walk"),
    ...
    list(name = "mushroom_man_4", type = "mushroom_man", x = 2750, y = 2250, hit_points = 6, damage = 5, motion = "walk"),
    list(name = "mushroom_man_5", type = "mushroom_man", x = 450, y = 3250, hit_points = 5, damage = 4, motion = "walk"),
    list(name = "mushroom_man_6", type = "mushroom_man", x = 1550, y = 3850, hit_points = 6, damage = 5, motion = "walk"),
    list(name = "mushroom_man_7", type = "mushroom_man", x = 2750, y = 3850, hit_points = 5, damage = 4, motion = "walk"),
    list(name = "mushroom_man_8", type = "mushroom_man", x = 2850, y = 4550, hit_points = 6, damage = 5, motion = "walk"),
    list(name = "mushroom_man_9", type = "mushroom_man", x = 850, y = 5350, hit_points = 5, damage = 4, motion = "walk"),
    list(name = "mushroom_man_10", type = "mushroom_man", x = 1950, y = 5650, hit_points = 6, damage = 5, motion = "walk"),
    list(name = "mushroom_man_11", type = "mushroom_man", x = 450, y = 1450, hit_points = 5, damage = 4, motion = "walk"),
    ...
    list(name = "mushroom_man_14", type = "mushroom_man", x = 1650, y = 2550, hit_points = 6, damage = 5, motion = "walk"),
    list(name = "mushroom_man_15", type = "mushroom_man", x = 2350, y = 3150, hit_points = 5, damage = 4, motion = "walk"),
    list(name = "mushroom_man_16", type = "mushroom_man", x = 3050, y = 3350, hit_points = 6, damage = 5, motion = "walk"),
    list(name = "mushroom_man_17", type = "mushroom_man", x = 850, y = 3950, hit_points = 5, damage = 4, motion = "walk"),
    list(name = "mushroom_man_18", type = "mushroom_man", x = 1650, y = 4750, hit_points = 6, damage = 5, motion = "walk"),
