...
ui <- shiny::tagList(
  htmltools::tags$style(htmltools::HTML("
    ...
    #dungeonheroes_loader .skeleton_loader_sprite {
      width: 100px;
      height: 100px;
      background-image: url('dungeonheroes-assets/sprites/enemies/skeleton/skeleton_idle.png');
    ...
    #choose_hero .character_portrait {
      background-image: url('dungeonheroes-assets/sprites/hero/human/hero_sword_idle.png');
    }

    #choose_orc .character_portrait {
      background-image: url('dungeonheroes-assets/sprites/hero/orc/hero_orc_idle.png');
    }

    #choose_elf .character_portrait {
      background-image: url('dungeonheroes-assets/sprites/hero/elf/hero_elf_idle.png');
    }
